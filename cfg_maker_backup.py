...
mr0_1 = "MR01st_QCD[35,0,200]"
mr0_1s = "MR01st_QCD_s[35]"

r0_1 = "R01st_QCD[-.0448, -.1, 0]"
r0_1s = "R01st_QCD_s[.0143]"

mr0_2 = "MR02nd_QCD[150,0,150]"
mr0_2s = "MR02nd_QCD_s[35]"

r0_2 = "R02nd_QCD[-6.19e-09,-.1,0]"
r0_2s = "R02nd_QCD_s[.00398]"

b_1 = "b1st_QCD[.269,.22,.4]"
b_1s = "b1st_QCD_s[.0498]"
...
ntot = "Ntot_QCD[900,700,1000]"

f2 = "f2_QCD[.0407,.001,.3]"
f2s = "f2_QCD_s[.0107]"
