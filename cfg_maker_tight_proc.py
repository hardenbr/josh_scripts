...
var_MR = "MR[270.,110.,3000]"
var_Rsq = "Rsq[.2,.05,1.2]"
...
mr0_1 = "MR01st_QCD[-4.2933,-200,200]"
mr0_1s = "MR01st_QCD_s[7.71]"

mr0_2 = "MR02nd_QCD[-51.311,-300,300]"
mr0_2s = "MR02nd_QCD_s[19.6]"

ntot = "Ntot_QCD[6000,0,30000]"

r0_1 = "R01st_QCD[-.081883, -.1, 0]"
r0_1s = "R01st_QCD_s[.00872]"

r0_2 = "R02nd_QCD[-.14912,-1,0]"
r0_2s = "R02nd_QCD_s[.0243]"

b_1 = "b1st_QCD[.23994,.05,100]"
b_1s = "b1st_QCD_s[.01600]"

b_2 = "b2nd_QCD[3.1418,.01,100]"
b_2s = "b2nd_QCD_s[1.42]"
...
pdf1_qcd = [mr0_1,mr0_1s, r0_1, r0_1s, b_1, b_1s,n_1s]
pdf2_qcd = [mr0_2,mr0_2s, r0_2, r0_2s, b_2, b_2s,n_2s]
