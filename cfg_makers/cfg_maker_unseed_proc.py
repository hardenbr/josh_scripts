...
mr0_1 = "MR01st_QCD[-13.206,-200,200]"
mr0_1s = "MR01st_QCD_s[8.33]"

mr0_2 = "MR02nd_QCD[-52.010,-300,300]"
mr0_2s = "MR02nd_QCD_s[19.0]"

ntot = "Ntot_QCD[6000,0,30000]"

r0_1 = "R01st_QCD[-.077494, -.1, 0]"
r0_1s = "R01st_QCD_s[.00851]"

r0_2 = "R02nd_QCD[-.12964,-1,0]"
r0_2s = "R02nd_QCD_s[.0210]"

b_1 = "b1st_QCD[.22616,.05,.5]"
b_1s = "b1st_QCD_s[.0152]"

b_2 = "b2nd_QCD[3.6772,.01,100]"
b_2s = "b2nd_QCD_s[1.6]"
