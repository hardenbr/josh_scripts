...
var_MR = "MR[220.,200.,3000.]"
var_Rsq = "Rsq[.06,.05,1.2]"

FULL_MR = "MR_FULL[200.,3000.]"
FULL_Rsq = "Rsq_FULL[.05,1.2]"

fR1_MR  = "MR_fR1[200.,400.]"
fR1_Rsq = "Rsq_fR1[.05,.07]"

fR2_MR  = "MR_fR2[200.,275.]"
fR2_Rsq = "Rsq_fR2[.07,.11]"

fR3_MR  = "MR_fR3[200.,230.]"
fR3_Rsq = "Rsq_fR3[.11,.35]"
...
mr0_1 = "MR0_QCD[27.555,-100,100]"
mr0_1s = "MR0_QCD_s[24.4]"

#mr0_2 = "MR02nd_QCD[-8.27,-100,100]"
#mr0_2s = "MR02nd_QCD_s[24]"

ntot = "Ntot_QCD[1000,0,2000]"

r0_1 = "R0_QCD[-.04594, -.1, .1]"
r0_1s = "R0_QCD_s[.0177]"

#r0_2 = "R02nd_QCD[-.1,-.1,0]"
#r0_2s = "R02nd_QCD_s[.0206]"

b_1 = "b_QCD[2.7623,0,20]"
b_1s = "b_QCD_s[.766]"

n_1 = "n_QCD[2.0942,0,5]"
n_1s = "n_QCD_s[.240]"
