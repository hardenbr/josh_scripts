...
if len(sys.argv) != 7 and len(sys.argv) != 8:
	print "usage filter_new_ohlt_config_maker.py <pmin> <pmax> <hlt.cfg> <full_path_to_output_dir> <njobs> <force_remove=1> <finished_jobs.txt OPTIONAL>"
        exit(1)
...
if len(sys.argv) == 8:
	finished_jobs = open(sys.argv[7], "r")
