{
  ...
  gStyle->SetOptStat(0);
  outTreeFF->Draw("PFR^2:PFMR>>hist2",fullcut+cut_ff,"colz");
  gStyle->SetOptStat(0);
  ...
  outTreeFF->Draw("PFR^2>>hist4", fullcut+cut_ff);
  ...
  outTreeFF->Draw("PFMR>>hist5", fullcut+cut_ff);

  hist5.GetXaxis().SetTitle("M_{R} [GeV]");
  hist5.GetYaxis().SetTitle("N events");
  hist5.SetTitle("M_{R} Fake-Fake");
  hists_1D[2] = hist5;
